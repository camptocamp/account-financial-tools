 ...
 * Create if needed the [project on Docker Hub](https://hub.docker.com/r/camptocamp/meteotest_odoo/)
 * Create access for Travis in this new project and put auth informations in Lastpass
  * user: c2cbusinessmeteotesttravis
  * password: Generated password
  * email: business-deploy+meteotest-travis@camptocamp.com (which is aliased on camptocamp@camptocamp.com)

On Travis, in [settings page](https://travis-ci.com/camptocamp/meteotest_odoo/settings) , add following environnement variables:
 * DOCKER_USERNAME : c2cbusinessmeteotesttravis
